...
sym_world = SymbolicWorld(world=frozenset(("alice", "bob", "carol", "davy")))

sym_alice = SymbolicPYU("alice")
sym_bob = SymbolicPYU("bob")
sym_carol = SymbolicPYU("carol")
sym_davy = SymbolicPYU("davy")
    ...
    sym_world.reify(
        SFConfigNetworked(
            ...
            network=dict(
                ...
                carol=PortBinding(announced_as="127.0,0.1:8082"),
                davy=PortBinding(announced_as="127.0.0.1:8083"),
            ),
        )
    )
