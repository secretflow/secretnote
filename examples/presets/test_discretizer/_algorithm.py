...
from secretflow.data.base import Partition as partition
...
def make_prod_env_and_data(sf_production_setup_devices):
    hdf = load_iris(
...
prod_env_and_data = next(make_prod_env_and_data(sf_simulation_setup_devices))

test_on_h_mixdataframe_should_ok_when_quantile(prod_env_and_data)
test_on_h_mixdataframe_should_ok_when_uniform(prod_env_and_data)
test_on_hdataframe_should_ok_when_quantile(prod_env_and_data)
test_on_hdataframe_should_ok_when_uniform(prod_env_and_data)
test_on_v_mixdataframe_should_ok_when_quantile(prod_env_and_data)
test_on_v_mixdataframe_should_ok_when_uniform(prod_env_and_data)
test_on_vdataframe_should_ok_when_quantile(prod_env_and_data)
test_on_vdataframe_should_ok_when_uniform(prod_env_and_data)
test_should_error_when_not_dataframe(prod_env_and_data)
test_transform_should_error_when_not_fit(prod_env_and_data)
test_tranform_should_error_when_diff_features_num(prod_env_and_data)
