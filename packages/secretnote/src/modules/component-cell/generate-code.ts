...
const getAttrValue = (key: string, value: any) => {
...
const getInputMetaType = (type: IOType) => {
...
const generateComponentCode = (component?: ComponentSpec, config?: Value) => {
  if (!(component && config)) {
    return '';
  }
  ...
  Object.entries(others).forEach(([key, value]) => {
    ...
    const attrValue = getAttrValue(key, value);
